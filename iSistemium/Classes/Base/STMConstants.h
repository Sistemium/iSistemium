...
#define WK_SCRIPT_MESSAGE_NAMES @[WK_MESSAGE_POST, WK_MESSAGE_GET, WK_MESSAGE_SCANNER_ON, WK_MESSAGE_FIND_ALL, WK_MESSAGE_FIND, WK_MESSAGE_UPDATE, WK_MESSAGE_UPDATE_ALL, WK_MESSAGE_DESTROY, WK_MESSAGE_SOUND, WK_MESSAGE_TABBAR]
