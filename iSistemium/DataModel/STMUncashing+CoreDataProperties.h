//
//  STMUncashing+CoreDataProperties.h
//  iSistemium
//
...
@interface STMUncashing (CoreDataProperties)
...
@property (nullable, nonatomic, retain) NSSet<STMUncashingPicture *> *pictures;
@property (nullable, nonatomic, retain) STMUncashingPlace *uncashingPlace;
...
- (void)addPictures:(NSSet<STMUncashingPicture *> *)values;
- (void)removePictures:(NSSet<STMUncashingPicture *> *)values;
